/*
 * 48. Escreva uma função que recebe como parâmetro uma lista simplesmente encadeada e um número
 * inteiro n e retorne uma lista com os valores menores que n.
 * Lista* ListaMenores(Lista *l, int n);
 *
 */
...
Lista *ListaMenores(Lista *lista, int n){
  Lista *nova = nova_lista();
  while(lista->prox != NULL){
    if(lista->num < n){
      nova = inserir_no_final(nova, lista->num);
    }
    lista = lista->prox;
  }
  return nova;
...
int main(){
  ...
  printf("48. Escreva uma função que recebe como parâmetro uma lista simplesmente encadeada e um número"
         "inteiro n e retorne uma lista com os valores menores que n.\n\n"
         "\tLista* ListaMenores(Lista *l, int n);\n\n");
  printf("\tlista         -> ");
  imprimir(lista);

  Lista *menor = ListaMenores(lista, 4);
  printf("\tmenores que 4 -> ");
  imprimir(menor);
  liberar(&menor);
  liberar(&lista);
  return 0;

/*
 * 19. Implemente uma função para verificar se uma lista linear encadeada está ordenada.
 */
...
int main(){
  ...
  printf("19. Implemente uma função para verificar se uma "
         "lista linear encadeada está ordenada.\n");
  printf("lista               -> ");
  imprimir(lista);
  printf("lista esta ordenada -> %d\n\n", checar_ordenagem(lista));
  liberar(&lista);

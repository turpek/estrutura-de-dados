/*
 * 20. Implementar uma função que retorna o valor do primeiro elemento. 
...
int primeiro_elemento(Lista *lista){
  if(lista == NULL){
    return -1;
  }
...
int main(){
  ...
  printf("20. Implementar uma função que retorna o valor do primeiro "
         "elemento. Se a lista estiver vazia, retornar -1.\n");
  printf("lista       -> ");
  imprimir(lista);
  printf("1o elemento -> %d\n", primeiro_elemento(lista));
  liberar(&lista);
  return 0;
}

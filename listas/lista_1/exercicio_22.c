/*
 * 22. Implementar uma função que retorna o endereço do último elemento. Se a lista estiver vazia, retornar NULL.
 */
...
Lista *memoria_ultimo_elemento(Lista *lista){
  if(lista == NULL){
    return NULL;
  }
  while(lista->prox != NULL){
